...
export interface Analysis { id: string; source_filename: string; character_count: number; status: string; recommendations: RecommendationSet | null; error_code: string | null; review_started_at: string | null; review_completed_at: string | null; freshness_status?: string | null; last_freshness_checked_at?: string | null }
...
export interface FreshnessEvidence { dataset_urn: string; category: string; field_path: string | null; old_value: unknown; new_value: unknown; affects_referenced_field: boolean; message: string }
